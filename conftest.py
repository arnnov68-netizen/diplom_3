...
def driver(request):
    ...
    Selenium Manager (встроен в Selenium 4.6+) сам скачает нужный драйвер,
    ...
    try:
        if browser == "chrome":
            ...
            # options.add_argument("--headless")  # раскомментировать для headless
        ...
        # Сохраняем имя браузера для использования в хуке скриншотов
