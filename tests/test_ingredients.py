...
class TestIngredients:
    ...
    def test_bun_modal_open(self, driver):
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_sauce_modal_open(self, driver):
        main_page = MainPage(driver)
        main_page.open(BASE_URL)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_filling_modal_open(self, driver):
        main_page = MainPage(driver)
        main_page.open(BASE_URL)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_multiple_additions(self, driver):
        main_page = MainPage(driver)
        main_page.open(BASE_URL)
