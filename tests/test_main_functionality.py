...
class TestMainFunctionality:
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_constructor_ingredient_modal_open(self, driver, base_url):
        main_page = MainPage(driver)
        main_page.open(base_url)
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_constructor_ingredient_modal_close(self, driver, base_url):
        main_page = MainPage(driver)
        main_page.open(base_url)
    ...
    def test_constructor_ingredient_details(self, driver, base_url):
        main_page = MainPage(driver)
        main_page.open(base_url)
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_constructor_counter_increases(self, driver, base_url):
        main_page = MainPage(driver)
        main_page.open(base_url)
